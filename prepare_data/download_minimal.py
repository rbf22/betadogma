...
DOWNLOADS: Dict[str, List[DownloadItem]] = {
    # -------------------------------------------------------------------------
    # REFERENCE GENOME
    # -------------------------------------------------------------------------
    "genome": [
...
LOCAL_FILES: List[LocalFileItem] = [
    {
...
def copy_local_file(source_path: Path, output_path: Path) -> bool:
    ...
    if not source_path.exists():
        ...
        print("     Place the file in the expected location and re-run")
        return False
...
Total: ~15 GB
    ...
    if stats["fail"] == 0:
        ...
        print("   ├── gencode/")
        print("   │   ├── v26/             # GTEx-compatible annotations ⭐")
        print("   │   └── v44/             # Latest annotations")
        print("   ├── gtex/")
        print("   │   └── v8/")
        print("   │       ├── expression/  # Transcript & gene TPM ⭐")
        print("   │       ├── metadata/    # Sample attributes ⭐")
        print("   │       └── junctions/   # Splice junctions")
        print("   └── variants/")
        print("       ├── clinvar/         # Pathogenic variants ⭐")
        print("       ├── 1000genomes/     # Benign variants ⭐")
        print("       └── splicevar/       # Splice variants ⭐")
        print()
        print("🎯 Next steps:")
